        ...
        <div class="new-form__container">
          <form id="new-form" class="new-form">
            <div class="form-control">
              <label for="documentations-input" class="new-form__documentations__title">Foto Kejadian</label>
            ...
            <div class="form-control">
              ...
              <div class="new-form__description__container">
                <textarea
                  ...
                  name="description"
                  placeholder="Masukkan keterangan cerita yang ingin anda bagikan."
                ></textarea>
              </div>
            </div>
