...
export default class ResultsPage {
  ...
  showResults(results) {
    console.log('Hasil results:', results);
    const resultsContent = document.getElementById('results-content');

    resultsContent.innerHTML = `
      <div class="result-card">
        <div class="result-image">
          <img src="${results.imageUrl || 'images/placeholder-result.jpg'}" alt="Analyzed skin condition">
        </div>
        <div class="result-details">
          <h3>Diagnosis: <span class="diagnosis">${results.predictedClass}</span></h3>
